...
//! Cucurbita that has culinary and cultural significance but no agreed upon botanical or scientific
//! meaning. The term pumpkin is sometimes used interchangeably with "squash" or "winter squash", and
//! is commonly used for cultivars of Cucurbita argyrosperma, Cucurbita ficifolia, Cucurbita maxima,
//! Cucurbita moschata, and Cucurbita pepo.
//!
...
impl Pumpkin {
    /// Smashed pumpkins will be gone and can't be used for pie 🥲
    pub fn smash(self) {}
}
...
/// `BURNT_ORANGE` is for "orangeness" field in [`Pumpkin`] struct
